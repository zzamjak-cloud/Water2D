...
`#v1.0.0` 을 생략하면 `main` 브랜치의 최신 상태를 가져옵니다.
...
{
  "dependencies": {
    "com.zzamjak.water2d": "https://github.com/zzamjak-cloud/Water2D.git?path=/Packages/com.zzamjak.water2d#v1.0.0"
  }
}
```
